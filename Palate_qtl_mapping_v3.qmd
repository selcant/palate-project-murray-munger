...
# }
# save( gsva_qtl, file = here("_data","GSVA_qtl_scans_v4.RData")) # I've changed the normalization of the data so re-running and saving as v4

load(here("_data","GSVA_qtl_scans_v4.RData"))
...
load( here("_data/DO_WGCNA_network_2025-02-12.RData")) # net_do
...
plot_lodpeaks(find_peaks(wgcna_qtl_scan, threshold = 7, pmap), pmap, main = "Peaks LOD > 6")
