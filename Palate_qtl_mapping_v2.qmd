...
load(here("../qtl_mapping/DO_Palate_eQTL_forMapping_v3.RData")) # expr, exprZ, genoprobs ..etc.
...
load(here("../qtl_mapping/DO_Palate_eQTL_effs_lod7_v3.RData")) # effects_blup, effects_std, peaks
...
# }
# save( gsva_qtl, file = here("_data","GSVA_qtl_scans_v3.RData")) # adding mammalian phenotypes

load(here("_data","GSVA_qtl_scans_v3.RData"))
...
plot_coefCC(chr13_pc1_qtl_eff_1, scan1_output =chr13_pc1_qtl_1, map = pmap , xlim= c(1e08, 1.1e08), main = "PC1 of chr13 eQTL hotspots targets")
...
plot_coefCC(chr13_pc1_qtl_eff_2, scan1_output =chr13_pc1_qtl_2, map = pmap , xlim= c(1e08, 1.1e08), main = "PC1 of chr13 eQTL hotspots targets")
...
peak1_plot<- ggarrange( peak_chr6_lod_plot, peak_chr6_eff_plot, widths = c(1, 0.5))
peak1_plot
...
# mediate with RNA data
peak1_marker <- map_dat2 %>%  filter( pos_bp == peak_chr6$pos)
...
#| #| fig-width: 12
#| fig-height: 8
plot_coefCC( peak_chr13_eff, pmap, scan1_output = lb_scan, xlim= c(1e08, 1.2e08))
